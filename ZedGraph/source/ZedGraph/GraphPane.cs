...
namespace ZedGraph
{
	...
	#region Rendering Methods
		...
		private void PickScale( IGraphics g, float scaleFactor )
		{
			int maxTics = 0;
			...
			foreach ( Y2Axis axis in _y2AxisList )
			{
				axis._scale.PickScale( this, g, scaleFactor );
				if ( axis._scale.MaxAuto )
				{
		...
		internal void DrawGrid( IGraphics g, float scaleFactor )
		{
		...
		public RectangleF CalcChartRect( IGraphics g )
		{
			// Calculate the chart rect, deducting the area for the scales, titles, legend, etc.
			//int		hStack;
			//float	legendWidth, legendHeight;
		...
		public RectangleF CalcChartRect( IGraphics g, float scaleFactor )
		{
...
//			minSpaceT = Math.Max( minSpaceT, spaceT );
		...
		public void SetMinSpaceBuffer( IGraphics g, float bufferFraction, bool isGrowOnly )
		{
	...
	#region General Utility Methods
		...
		public bool FindNearestObject( PointF mousePt, IGraphics g, 
		...
		/// </returns>
		public bool FindLinkableObject( PointF mousePt, IGraphics g, float scaleFactor,
