...
namespace ZedGraph
{
	...
	#region Rendering Methods
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>
		public void Draw( IGraphics g, PaneBase pane, string text, float x,
	...
	#region Sizing Methods
		...
		public SizeF MeasureString( IGraphics g, string text, float scaleFactor )
		{
			Remake( scaleFactor, this.Size, ref _scaledSize, ref _font );
		...
		/// <returns>The scaled text dimensions, in pixels, in the form of
		/// a <see cref="SizeF"/> struct</returns>
		public SizeF BoundingBox( IGraphics g, string text, float scaleFactor )
		{
		...
		/// <returns>The scaled text dimensions, in pixels, in the form of
		/// a <see cref="SizeF"/> struct</returns>
		public SizeF BoundingBox( IGraphics g, string text, float scaleFactor, SizeF layoutArea )
		{
			//Remake( scaleFactor, this.Size, ref this.scaledSize, ref this.font );
			SizeF s;
			if ( layoutArea.IsEmpty )
