...
namespace ZedGraph
{
	...
	#region Rendering Methods
		...
		/// </param>
		public void Draw( IGraphics g, GraphPane pane, float scaleFactor, float shiftPos )
		{
		...
		internal void DrawGrid( IGraphics g, GraphPane pane, float scaleFactor, float shiftPos )
		{
			if ( _isVisible )
			{
				Matrix saveMatrix = g.Transform;
		...
		public void SetMinSpaceBuffer( IGraphics g, GraphPane pane, float bufferFraction,
										bool isGrowOnly )
		{
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>
		abstract public void SetTransformMatrix( IGraphics g, GraphPane pane, float scaleFactor );
...
//		abstract internal float GetMinPix( GraphPane pane );
		...
		public float CalcSpace( IGraphics g, GraphPane pane, float scaleFactor, out float fixedSpace )
		{
			//fixedSpace = 0;
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>
		public void DrawTitle( IGraphics g, GraphPane pane, float shiftPos, float scaleFactor )
		{
			string str = MakeTitle();
