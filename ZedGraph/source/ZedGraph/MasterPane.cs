...
namespace ZedGraph
{
    ...
    public class MasterPane : PaneBase, ICloneable, ISerializable, IDeserializationCallback
    {
        ...
        /// <see cref="SetLayout(IGraphics,bool,int[],float[])"/> method.  This values will be
        /// null if <see cref="SetLayout(IGraphics,bool,int[],float[])"/> was never called.
        /// </summary>
        ...
        /// <see cref="CountList"/> is specifying rows or columns.
        /// </summary>
        internal bool IsColumnSpecified;
        /// <summary>
        /// private field that determines if the
        /// <see cref="DoLayout(IGraphics)" />
        ...
        /// </summary>
        private bool isCommonScaleFactor;
        /// <summary>
        ...
        /// </summary>
        private bool isUniformLegendEntries;

        /// <summary>
        /// private field that saves the paneLayout format specified when
        /// <see cref="SetLayout(IGraphics,ZedGraph.PaneLayout)"/> was called. This value will
        /// default to <see cref="MasterPane.Default.PaneLayout"/> if
        /// <see cref="SetLayout(IGraphics,ZedGraph.PaneLayout)"/> (or an overload) was never called.
        /// </summary>
        internal PaneLayout PaneLayout;
        /// <summary>
        ...
        /// to the <see cref="SetLayout(IGraphics,bool,int[],float[])"/> method.  This
        /// value will be null if <see cref="SetLayout(IGraphics,bool,int[],float[])"/>
        /// was never called.  
        /// </summary>
        internal float[] Prop;
...
*/
        ...
        public new struct Default
        {
            ...
            /// method calls.
            /// </summary>
            /// <seealso cref="SetLayout(IGraphics,ZedGraph.PaneLayout)" />
            /// <seealso cref="SetLayout(IGraphics,int,int)" />
            /// <seealso cref="SetLayout(IGraphics,bool,int[])" />
            /// <seealso cref="SetLayout(IGraphics,bool,int[],float[])" />
            /// <seealso cref="ReSize(IGraphics,RectangleF)" />
        ...
        public PaneList PaneList{get {return _paneList;}set {_paneList = value;}}
/*
        /// <summary>
...
*/
        ...
        public float InnerPaneGap{get {return _innerPaneGap;}set {_innerPaneGap = value;}}
        /// <summary>
        /// Gets or set the value of the	 <see cref="IsUniformLegendEntries"/>
        /// </summary>
        public bool IsUniformLegendEntries{get {return (isUniformLegendEntries);}set {isUniformLegendEntries = value;}}

        /// <summary>
        /// Gets or sets a value that determines if the
        /// <see cref="DoLayout(IGraphics)" /> method will automatically set the
        ...
        /// <seealso cref="SetLayout(IGraphics,bool,int[],float[])" />
        /// <seealso cref="ReSize(IGraphics,RectangleF)" />
        public bool IsCommonScaleFactor{get {return isCommonScaleFactor;}set {isCommonScaleFactor = value;}}
        ...
        /// will be honored.
        /// </summary>
        public bool IsAntiAlias{get {return isAntiAlias;}set {isAntiAlias = value;}}
        #endregion
        ...
        public MasterPane(string title, RectangleF paneRect) : base(title, paneRect)
        {
            ...
            isUniformLegendEntries = Default.IsUniformLegendEntries;
            isCommonScaleFactor = Default.IsCommonScaleFactor;
        ...
        public MasterPane(MasterPane rhs) : base(rhs)
        {
            ...
            PaneLayout = rhs.PaneLayout;
            CountList = rhs.CountList;
            IsColumnSpecified = rhs.IsColumnSpecified;
            Prop = rhs.Prop;
        ...
        protected MasterPane(SerializationInfo info, StreamingContext context) : base(info, context)
        {
            ...
            PaneLayout = (PaneLayout) info.GetValue("paneLayout", typeof(PaneLayout));
            CountList = (int[]) info.GetValue("countList", typeof(int[]));

            IsColumnSpecified = info.GetBoolean("isColumnSpecified");
            Prop = (float[]) info.GetValue("prop", typeof(float[]));
        ...
        public GraphPane this[int index]{get {return (_paneList[index]);}set {_paneList[index] = value;}}
        ...
        /// <see cref="GraphPane"/> object to be accessed.</param>
        /// <value>A <see cref="GraphPane"/> object reference.</value>
        public GraphPane this[string title]{get {return _paneList[title];}}
        ...
        /// </param>
        public void AxisChange(IGraphics g)
        {
        ...
        /// contents by calling <see cref="DoLayout(IGraphics)"/>.
        /// </summary>
        /// <remarks>This method will use the pane layout that was specified by a call to
        /// <see cref="SetLayout(IGraphics,ZedGraph.PaneLayout)"/>.  If
        /// <see cref="SetLayout(IGraphics,ZedGraph.PaneLayout)"/> has not previously been called,
        ...
        /// <seealso cref="SetLayout(IGraphics,bool,int[])" />
        /// <seealso cref="SetLayout(IGraphics,bool,int[],float[])" />
        public void ReSize(IGraphics g)
        {
            ReSize(g, _rect);
        }
        ...
        /// <seealso cref="SetLayout(IGraphics,bool,int[])" />
        /// <seealso cref="SetLayout(IGraphics,bool,int[],float[])" />
        public override void ReSize(IGraphics g, RectangleF rect)
        {
            _rect = rect;
            DoLayout(g);
            CommonScaleFactor();
        ...
        public bool FindNearestPaneObject(PointF mousePt, IGraphics g, out GraphPane pane,
        ...
        /// to <see cref="PaneBase.ReSize" /> or <see cref="DoLayout(IGraphics)" />
        ...
        /// the list to a pre-defined layout configuration from a <see cref="ZedGraph.PaneLayout" />
        /// enumeration.
        /// </summary>
        /// <remarks>This method uses a <see cref="ZedGraph.PaneLayout"/> enumeration to describe the type of layout
        /// to be used.  Overloads are available that provide other layout options</remarks>
        /// <param name="paneLayout">A <see cref="ZedGraph.PaneLayout"/> enumeration that describes how
        ...
        /// <seealso cref="SetLayout(IGraphics,bool,int[])" />
        /// <seealso cref="SetLayout(IGraphics,bool,int[],float[])" />
        public void SetLayout(IGraphics g, PaneLayout paneLayout)
        {
            InitLayout();
        ...
        /// <seealso cref="SetLayout(IGraphics,bool,int[])" />
        /// <seealso cref="SetLayout(IGraphics,bool,int[],float[])" />
        public void SetLayout(IGraphics g, int rows, int columns)
        {
            InitLayout();
        ...
        /// <seealso cref="SetLayout(IGraphics,int,int)" />
        /// <seealso cref="SetLayout(IGraphics,bool,int[],float[])" />
        public void SetLayout(IGraphics g, bool isColumnSpecified, int[] countList)
        {
        ...
        /// <seealso cref="SetLayout(IGraphics,int,int)" />
        /// <seealso cref="SetLayout(IGraphics,bool,int[])" />
        public void SetLayout(IGraphics g, bool isColumnSpecified, int[] countList, float[] proportion)
        {
            InitLayout();
            ...
            {
                Prop = new float[countList.Length];

                // Sum up the total proportional factors
                float sumProp = 0.0f;
                for (int i = 0; i < countList.Length; i++)
                {
                    Prop[i] = (proportion == null || proportion.Length <= i || proportion[i] < 1e-10)
                                           ? 1.0f
                                           : proportion[i];
                    sumProp += Prop[i];
                }
                ...
                IsColumnSpecified = isColumnSpecified;
                CountList = countList;
        ...
        /// </summary>
        /// <remarks>The <see cref="SetLayout(IGraphics,ZedGraph.PaneLayout)" /> method (and overloads) is
        /// used for setting the layout configuration.</remarks>
        /// <seealso cref="SetLayout(IGraphics,ZedGraph.PaneLayout)" />
        /// <seealso cref="SetLayout(IGraphics,int,int)" />
        /// <seealso cref="SetLayout(IGraphics,bool,int[])" />
        /// <seealso cref="SetLayout(IGraphics,bool,int[],float[])" />
        public void DoLayout(IGraphics g)
        {
            if (CountList != null)
            {
                DoLayout(g, IsColumnSpecified, CountList, Prop);
            }
            else
            {
        ...
        /// <see cref="DoLayout(IGraphics)" />.
        /// </summary>
        internal void DoLayout(IGraphics g, int rows, int columns)
        {
            if (rows < 1)
            {
                rows = 1;
        ...
        /// <see cref="DoLayout(IGraphics)" />.
        /// </summary>
        internal void DoLayout(IGraphics g, bool isColumnSpecified, int[] countList,
                    float[] proportion)
        {
            ...
            if (isColumnSpecified)
            {
                ...
                {
                    float propFactor = Prop == null ? 1.0f / rows : Prop[rowNum];
            ...
            else
            {
                ...
                for (int colNum = 0; colNum < columns; colNum++)
                {
                    float propFactor = Prop == null ? 1.0f / columns : Prop[colNum];
