...
namespace ZedGraph
{
	...
	#region Rendering Methods
		...
		/// </param>
		abstract public void Draw( IGraphics g, PaneBase pane, float scaleFactor );
		...
		virtual public bool PointInBox( PointF pt, PaneBase pane, IGraphics g, float scaleFactor )
		{
