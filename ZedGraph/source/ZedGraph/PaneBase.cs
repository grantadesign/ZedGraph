...
namespace ZedGraph
{
	...
	#region Methods
		...
		public RectangleF CalcClientRect( IGraphics g, float scaleFactor )
		{
		...
		/// represents a linear multiple to be applied to font sizes, symbol sizes, etc.
		/// </param>		
		public void DrawPaneFrame( IGraphics g, float scaleFactor )
		{
		...
		/// represents a linear multiple to be applied to font sizes, symbol sizes, etc.
		/// </param>		
		public void DrawTitle( IGraphics g, float scaleFactor )
		{	
		...
		public virtual void ReSize( IGraphics g, RectangleF rect )
		{
			_rect = rect;
		}
		...
		public float CalcScaleFactor()
		{
			...
			float scaleFactor = length / ( _baseDimension * 72F );
		...
		{
		    return _isPenWidthScaled ? penWidth * scaleFactor : penWidth;
		}
		...
		internal void SetAntiAliasMode( IGraphics g, bool isAntiAlias )
		{
			if ( isAntiAlias )
			{
