...
namespace ZedGraph
{
   ...
   public class Bar : ICloneable, ISerializable
   {
	...
	#region Rendering Methods
		...
		/// </param>
		public void Draw( IGraphics g, GraphPane pane, float left, float right, float top,
		...
		/// with attributes from the <see cref="Selection" /> class.
		/// </param>
		public void Draw( IGraphics g, GraphPane pane, RectangleF rect, float scaleFactor,
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>
		public void DrawSingleBar( IGraphics g, GraphPane pane, CurveItem curve,
									Axis baseAxis, Axis valueAxis,
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>
		virtual protected void DrawSingleBar( IGraphics g, GraphPane pane,
										CurveItem curve,
