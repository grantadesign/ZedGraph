...
namespace ZedGraph
{
	...
	#region Defaults
		...
		/// </param>
		public void Draw( IGraphics g, PaneBase pane, float scaleFactor )
		{
		...
		private float GetMaxHeight( PaneList paneList, IGraphics g, float scaleFactor )
		{
		...
		/// </param>
		public void CalcRect( IGraphics g, PaneBase pane, float scaleFactor,
