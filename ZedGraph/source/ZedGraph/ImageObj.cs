...
namespace ZedGraph
{
	...
	#region Rendering Methods
		...
		/// </param>
		override public void Draw( IGraphics g, PaneBase pane, float scaleFactor )
		{
			if ( _image != null )
			{
		...
		override public bool PointInBox( PointF pt, PaneBase pane, IGraphics g, float scaleFactor )
		{
			if ( _image != null )
			{
