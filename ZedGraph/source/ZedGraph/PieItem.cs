...
*/
		...
		public static ColorSymbolRotator Rotator = new ColorSymbolRotator();
 ...
 */
		...
		{
			_pieValue = pieValue;
			_fill = new Fill( color.IsEmpty ? Rotator.NextColor : color );
		...
		/// </param>				
		override public void Draw( IGraphics g, GraphPane pane, int pos, float scaleFactor )
		{
		...
		/// <returns></returns>
		public static RectangleF CalcPieRect( IGraphics g, GraphPane pane, float scaleFactor, RectangleF chartRect )
		{
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>				
		public void DrawLabel( IGraphics g, GraphPane pane, RectangleF rect, float scaleFactor )
		{
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>
		public void DesignLabel( IGraphics g, GraphPane pane, RectangleF rect, float scaleFactor )
		{
			if ( !_labelDetail.IsVisible )
				return;
		...
		/// font sizes, etc. according to the actual size of the graph.
		/// </param>
		override public void DrawLegendKey( IGraphics g, GraphPane pane, RectangleF rect, float scaleFactor )
		{
			if ( !_isVisible )
				return;
